...
XHR.prototype.post = function(url, data, onSuccess, onError, extraParams) {
    ...
    extraParams.hasOwnProperty("enctype") || (extraParams.contentType = extraParams.contentType || "application/json");
    ...
    xhr.setTimeout(1e4);
    extraParams.hasOwnProperty("enctype") ? xhr.setRequestHeader("enctype", extraParams.enctype) : xhr.setRequestHeader("Content-Type", extraParams.contentType);
    ...
    xhr.onload = function() {
        ...
        Ti.API.info("------SUCCESS RESPONSE TEXT--------:" + xhr.responseText);
...
XHR.prototype.post2 = function(url, data, onSuccess, onError, extraParams) {
    Titanium.API.info(url + " " + JSON.stringify(data));
    var onSuccess = onSuccess || function() {};
    var onError = onError || function() {};
    var extraParams = extraParams || {};
...
XHR.prototype.post3 = function(url, data, onSuccess, onError, extraParams) {
    Titanium.API.info(url + "    " + JSON.stringify(data));
    var onSuccess = onSuccess || function() {};
    var onError = onError || function() {};
    var extraParams = extraParams || {};
    ...
    xhr.open("POST", url, extraParams.async);
    xhr.setTimeout(1e4);
    if (null != Ti.App.Properties.getString("sessionValue")) xhr.setRequestHeader("Cookie", "_session=" + Ti.App.Properties.getString("sessionValue")); else if (extraParams.shouldAuthenticate) {
        var authstr = "Basic " + Titanium.Utils.base64encode(extraParams.username + ":" + extraParams.password);
        xhr.setRequestHeader("Authorization", authstr);
    }
    xhr.onload = function() {
...
XHR.prototype.get = function(url, onSuccess, onError, extraParams) {
    Titanium.API.info(url + " " + JSON.stringify(extraParams));
    var onSuccess = onSuccess || function() {};
    var onError = onError || function() {};
    var extraParams = extraParams || {};
    extraParams.async = extraParams.hasOwnProperty("async") ? extraParams.async : true;
